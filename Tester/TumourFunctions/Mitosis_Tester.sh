...
g++ -Wall -shared -I/usr/local/inlcude -I"$core_path" -c Mitosis_Tester.cpp --std=c++11
...
g++ -lgsl  Mitosis_Tester.o config.o Clone.o clonalFun.o inout_funs.o ClonalExpansion.o Random.o -o Mitosis_Tester 
